...
MACHINE_MAP = {
    ...
    "EVB-CTS-C(원통형) 4680 MP1 46ES": ["EVB-CTS-C(원통형) 4680 MP1 46ES", "MP1 46ES", "4680 MP1", "46ES", "MP1"],
    "EVB-CTS-C(원통형) 4695": ["4695", "N32S2", "선행검증", "CTA"],
    "EVB-XFP-A(HJV)": ["HJV", "XFP"],
    "1호기": ["1호기"],
    "2호기": ["2호기"],
    "JH3": ["JH3"],
    "SES 탑머터리얼": ["SES 탑머터리얼", "탑머터리얼", "SES TAP", "탑머", "SES"],
    "LGES MI JF2": ["LGES MI JF2", "MI JF2", "JF2"],
}
